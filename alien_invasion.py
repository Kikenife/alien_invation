...
class AlienInvasion:
    ...
    def _make_difficulty_buttons(self):
        ...
        """Position button so they don't all overlap"""
        ...
        #Initialize the medium button to the higlighted color.
    ...
    def _check_events(self):
        """Respont to any keypresses and mouse events"""
    ...
    def _update_aliens(self):
        ...
        #watch out for aliens that hits the bottom of the screen.
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            ...
            #Gte rid of any remaining bullets and aliens.
            self.bullets.empty()
            self.aliens.empty()
    ...
    def _check_bullet_alien_collisions(self):
        """Respond to bullet_alien coliisions."""
    ...
    def _create_fleet(self):
        ...
        #Spacing between alien is one alien's width and one alien's height.
        alien = Alien(self)
    ...
    def _update_screen(self):
        """update images on the new screen and flip to the new screen"""
